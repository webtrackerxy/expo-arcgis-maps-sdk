...
config.resolver.extraNodeModules = {
  // Absolute path so resolution works regardless of the bundler's CWD
  // (the Release "Bundle React Native" phase runs from a different directory).
  'expo-arcgis-maps-sdk': path.resolve(__dirname, '..'),
};
